...
public class MintegralXBanner extends CustomEventBanner implements BannerAdListener {
    ...
    protected void loadBanner(final Context context, CustomEventBannerListener customEventBannerListener, Map<String, Object> localExtras, Map<String, String> serverExtras) {
        ...
        if (localExtras.containsKey(AD_WIDTH) && localExtras.containsKey(AD_HEIGHT)) {
            final int adwidth = (int) localExtras.get(AD_WIDTH);
            final int adheight = (int) localExtras.get(AD_HEIGHT);
            ...
            try {
                ...
                mtgBannerView.setBannerAdListener(MintegralXBanner.this);
                mtgBannerView.load();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void onLoadSuccessed() {
        Log.d(TAG, "onLoadSuccessed: "); //TODO bo comment
